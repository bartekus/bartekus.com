...
An update from 2026: these constraints turned out to generalize beyond distributed systems. My platform work now applies the same philosophy to AI agents writing code: clear boundaries become typed spec ownership, blast radius becomes gated authority, and observability becomes an audit chain. If that direction interests you, start with [Architecting intent vs vibe coding](/writing/architecting-intent-vs-vibe-coding).
...
*Have thoughts on resilient system design? I'd love to hear them. Reach out via [email](mailto:bartekus@gmail.com) or [LinkedIn](https://linkedin.com/in/bartekus).*
