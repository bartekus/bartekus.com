...
→ Use OIDC with an established provider (Keycloak, Logto, Auth0); I run Rauthy in production and recommend it
...
An update from 2026: identity turned out to be the first layer of a longer arc. The question OIDC answers for people (who is this, and what may they do) is the question my governance work now answers for AI agents and the code they produce. Identity infrastructure that treats authority as something to be proven rather than assumed scales up surprisingly well; see [Architecting intent vs vibe coding](/writing/architecting-intent-vs-vibe-coding).
