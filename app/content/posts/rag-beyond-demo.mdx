...
Rereading this in 2026: everything above is a special case of a rule I now apply to every AI system I build: keep the probabilistic parts behind deterministic gates. Retrieval and generation are probabilistic; eval sets, guardrails, citations, and observability are the deterministic shell that makes their output admissible. The general form is written up in [Probabilistic AI behind deterministic gates](/writing/probabilistic-ai-behind-deterministic-gates).
